...
zing-grid[loading]{height:800px;}</style>
    ...
    <h1 class="text-center">Raspberry Pi Weather Station Log - Project 2018-2019</h1>
    
       <div id="navbar3" class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-right">
          <li class="active"><a href="../weatherst1/index.php">Home</a></li>
          <li class="active"><a href="../weatherst1/showallgraphs.php">Graphs</a></li>
          <li class="active"><a href="../weatherst1/review_data3.php">Measurement</a></li>
          <li class="active"><a href="../weatherst1/review_location.php">Location</a></li>
        </div>
        </div>
		<div id='myChart'></div>
		<div id='myChart1'></div>
			...
			"graphset":[
				{
					"type":"line",
					"title":{
						"text":"Humidity from MySQL Database"
					},
					"scale-x":{
						"labels":myLabels1,
						"step": 10800
			...
			"graphset":[
				{
					"type":"line",
					"title":{
						"text":"Pressure from MySQL Database"
					},
					"scale-x":{
						"labels":myLabels3,
						"step": 10800
